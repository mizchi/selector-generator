...
// NOTE(mizchi): Only JS/JSONL to work on browser
import {
  NestedSelectorBody,
  ...
  parseSelector,
  stringifySelector,
} from "../playwright-src/packages/playwright-core/src/utils/isomorphic/selectorParser";
import {
  escapeWithQuotes,
  normalizeEscapedRegexQuotes,
} from "../playwright-src/packages/playwright-core/src/utils/isomorphic/stringUtils";
    ...
    switch (kind) {
      case "default":
        if (options.hasText !== undefined)
          return `locator(${this.quote(
            body as string
          )}, { hasText: ${this.toHasText(options.hasText)} })`;
        if (options.hasNotText !== undefined)
          return `locator(${this.quote(
            body as string
          )}, { hasNotText: ${this.toHasText(options.hasNotText)} })`;
